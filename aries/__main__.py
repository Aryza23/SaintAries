...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "⌊Sαιητ λrιεs Oηlιηε Πσω....⌉")
        except Unauthorized:
            LOGGER.warning(
...
async def start(client, message):
   if message.chat.type == 'private':
       await message.reply("**Hey There, I'm Aries. An advanced chatbot with AI. \n\nAdd me to your group and chat with me!**",   
                            reply_markup=InlineKeyboardMarkup(
                                [[
                                        InlineKeyboardButton(
                                            "Dev", url="https://t.me/IdzXartez"),
                                        InlineKeyboardButton(
                                            "Repo", url="https://github.com/idzero23")
                                    ]]
                            ),               
           )
   else:
