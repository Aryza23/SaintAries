...
# from aries.db.mongo_helpers.nsfw_guard import add_chat, get_all_nsfw_chats, is_chat_in_db, rm_chat
from aries.pyrogramee.telethonbasics import is_admin
from aries.events import register
from aries import MONGO_DB_URI 
from pymongo import MongoClient
from aries.modules.sql_extended.nsfw_watch_sql import (
    add_nsfwatch,
...
async def nsfw_watch(client, message):
    ...
    if not hot:
        ...
        await client.send_message(
            message.chat.id,
            f"**NSFW DETECTED**\n\n{hehe}'s message contain NSFW content.. So, Aries deleted the message\n\n **Nsfw Sender - User / Bot :** `{Escobar}` \n**Chat Title:** `{ctitle}` \n\n`⚔️Automatic Detections Powered By AriesAI` \n**#GROUP_GUARDIAN** ",
        )
        message.continue_propagation()
"""
