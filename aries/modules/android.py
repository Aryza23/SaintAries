...
BOOTLEGGERS_HANDLER = CommandHandler("bootleggers", bootleggers, admin_ok=True, run_async=True)
...
ENES_HANDLER = CommandHandler("enes", enesrelease, pass_args=True, admin_ok=True, run_async=True)
PHH_HANDLER = CommandHandler("phh", phh, pass_args=True, admin_ok=True, run_async=True)
EDXPOSED_HANDLER = CommandHandler("edxposed", edxposed, pass_args=True, admin_ok=True, run_async=True)
MITOOLS_HANDLER = CommandHandler("mitools", mitools, pass_args=True, admin_ok=True, run_async=True)
