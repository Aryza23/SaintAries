...
AD_STRINGS = (
    "__kembali dengan versi terbaik, karna di sini aku masih menunggumu,masih tentang kamu__",
    "__healing terbaik jatuh kepada rebahan, jalan jalan dan makanan enak__",
)
