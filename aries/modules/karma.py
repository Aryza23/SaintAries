...
from KanekiRobot import pbot as app, BOT_USERNAME
from KanekiRobot.utils.errors import capture_err
from KanekiRobot.utils.permissions import adminsOnly
from KanekiRobot.modules.mongo.karma_mongo import (alpha_to_int, get_karma,
                                   get_karmas, int_to_alpha, update_karma)      
from KanekiRobot.utils.filter_groups import (karma_positive_group, 
                                        karma_negative_group)
                           
                                   
from KanekiRobot.modules.mongo.karma_mongo import is_karma_on, karma_off, karma_on
...
async def command_karma(_, message):
    ...
    if not message.reply_to_message:
        ...
        if not karma:
            ...
            return
        msg = f"**Top list of Karma in the {message.chat.title}»:** \n"
        limit = 0
        karma_dicc = {}
        for i in karma:
