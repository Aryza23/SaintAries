...
from RakaRobot import OWNER_ID, SUPPORT_CHAT
from RakaRobot.events import register
from RakaRobot import telethn
...
async def lego(event):
 ...
 try:
    ...
    fname = "ARIES.png"
    img.save(fname, "png")
    await telethn.send_file(event.chat_id, file=fname, caption = f"Made by @IDZEROID_BOT")         
    await pesan.delete()
