...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "I'm looking for Idz, oh wait nvm it's {first}.",  # One Punch man s2
    ...
    "Hey, {first}, ever heard the Artezid Engine?",  # One Punch ma
    ...
    "I'm Gonna Destroy Them! Every last one of those Idz thats on this earth",
