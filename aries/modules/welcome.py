    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            if new_mem.id in DRAGONS:
                update.effective_message.reply_text(
                    "Huh! A Dragons Syndicates Users just joined! Stay Alert!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            if new_mem.id in DEMONS:
                update.effective_message.reply_text(
                    "Huh! Someone with a Demons Syndicates Users just joined!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            if new_mem.id in WOLVES:
                update.effective_message.reply_text(
                    "Oof! A Wolves Syndicates Users just joined!", reply_to_message_id=reply
                )
                continue
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                ...
                                InlineKeyboardButton(
                                    text="Updates", url="https://t.me/idzeroid"
                                ),
                            ]
                        ],
                    ),
